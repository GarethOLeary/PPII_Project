...
class Home1 extends React.Component {
    ...
    componentDidMount() {
        if(localStorage.getItem('Homestate')){
            ...
            const endpoint = `${API_URL2}movie/popular?api_key=${API_KEY}&language=en-US&page=1`;
    ...
    loadMoreItems = () => {
        ...
        if(this.state.searchTerm === ''){
            endpoint = `${API_URL2}movie/popular?api_key=${API_KEY}&language=en-US&page=${this.state.currentPage + 1}`;
        } else {
